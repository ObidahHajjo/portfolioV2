...
export default function HeroSection({ data }: HeroSectionProps) {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-slate-950 px-6 py-24 text-white" id="hero">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-xl font-medium text-sky-100 sm:text-2xl">{data.title}</p>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">{data.tagline}</p>
        </div>
        <div>
          <a

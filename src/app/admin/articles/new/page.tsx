    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold text-foreground">New Article</h1>
        </div>
      ...
      <Card className="max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>Link to an externally published article.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button type="button" variant="outline" render={<Link href="/admin/articles" />}>
                  Cancel
                </Button>
              </div>
            </form>
